...
autocmd VimEnter * NERDTree | wincmd p | vertical resize +8
...
nnoremap <leader>j :res +3<CR>
nnoremap <leader>k :res -3<CR>
...
nnoremap <silent><nowait> <space>b  :<C-u>CocPrev<CR>
